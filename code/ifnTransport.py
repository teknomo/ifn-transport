...
class IFNTransport:
    def __init__(self, scenarioFName):
        ...
        self.maxAllowableCongestion = None
        self.dfLink = None
        self.dfNode = None
    ...
    def findOptScaling(self, realFlowFName):
        """
    ...
    def display_network(self, field='Capacity'):
        ...
        for index, row in self.dfLink.iterrows():
            ...
            node1 = row.Node1
            node2 = row.Node2
            if self.cloudNode != node1 and self.cloudNode != node2:
...
if __name__ == '__main__':
    if len(sys.argv)>1:
        ...
        # scenario = folder + 'Scenario2.scn'
        folder = os.path.abspath('..') + '\\sample\\Ateneo\\'
        scenario = folder + 'BaseScenario.scn'

        print('running ',scenario)
    net=IFNTransport(scenario)
    net.runScenario()
